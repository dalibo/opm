package PgFactory::I18N::fr;
use Mojo::Base "PgFactory::I18N";
use utf8;
...
our %Lexicon = (
    ...
    "Could not add account to user"           => "Impossible d'ajouter le groupe à l'utilisateur",
    ...
    "Could not remove account from user"      => "Impossible de retirer le groupe de l'utilisateur",
);
